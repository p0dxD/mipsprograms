...
hideEncoding_text: .asciiz "WHENEVER STUDENTS"
hideEncodin: .asciiz "Whenever students"
hideEncodi: .asciiz "Whenever sts"
lbass: .byte 6
# findEncoding
findEncoding_header: .asciiz "\n\n********* findEncoding *********\n"
findEncoding_baconEncoding: .space 11
findEncoding_text: .asciiz "WhENeveR stUDeNts PrOGrAM LoVeLy CodE veRY  lAte At nigHt, my bRAIN ExpLoDES! *SIgh sigh sigh*"
#findEncoding_text: .asciiz "WhENeveR stUDeNts nigHt, my bRAIN oDES! *SIgh sigh sigh*"
...
#decodeBacon_baconEncoding: .asciiz "BABBAAABAABBABAABABBABBBABABABAABAABBABAABBAAABAAAABBBBBAABAAAAAAAAAAAAAAAAAABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABABAB"
decodeBacon_text: .space 201
