...
moves: .asciiz "w"
movestwo: .asciiz "aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaasssssssssssssssssssssssssss"
movesThree: .asciiz "wwwwwasaaasaaawsdawsdawdawsdawsdawsaawwwwwwwwwwg6dsssssssssssssssshjg56ssaaaaaaaaaaaaaaaaaaaaaaahgvhcr9aaaaaaaaaasasasasasasasasasasasasasasasa"
#.align 1
.text
	li $a0, 0xffff0000
	la $a1, first
